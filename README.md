...
```json
{
  "mcpServers": {
    "dataform-context": {
      ...
      "args": ["--from", "git+ssh://git@github.com/vgossiaux/dataform-context-mcp@v0.2.0",
...
command = "/opt/homebrew/bin/uvx"
args = ["--from", "git+ssh://git@github.com/vgossiaux/dataform-context-mcp@v0.2.0", "dataform-context", "serve"]
```
...
`uvx --from git+ssh://git@github.com/vgossiaux/dataform-context-mcp@v0.2.0 dataform-context …` :
