---
description: Vérifie l'installation dataform-context (dataform CLI, compilation, index, lineage, goldens)
allowed-tools: mcp__dataform-context__check_setup
---
